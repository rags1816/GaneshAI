    ...
    <div class="puja-card">
        ...
        <div id="puja-form">
            ...
            <div class="form-group">
                ...
                <select id="lang-select" class="select-input" onchange="langManuallySet = true;">
        ...
        <div style="text-align:center; font-size:10px; opacity:0.5; padding-top:8px;">Puja page: 2026-08-09-r88</div>
    </div>
