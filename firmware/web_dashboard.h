...
(function () {
    ...
    <script>
        ...
        const AARTI_FALLBACK_DURATION_MS = 206000; // r136: reverted r132 - GaneshAarti.mp3 alone (3:26), matches config.h's AARTI_DURATION
        ...
        // r131/r136: kept in sync with GanapatiAI.ino's own mantraTracks[] -
        // track 14's duration corrected to its real re-recorded length
        // (102000ms, was 175730). Track 10 restored (r136 reverted r132's
        // "plays after Aarti" change - it's a plain feet mantra again).
        const mantraTracks = [
        ...
        // mouseChantTracks[]/AARTI_TRACK/BELL_TRACK.
        const allPlayableTracks = [
            ...
            { track: 10, label: "10 - Feet mantra", duration: 125520 },
            ...
            { track: 16, label: "16 - Aarti", duration: 206000 },
