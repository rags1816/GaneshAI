            ...
            if (newState === "STANDBY") {
                ...
                autoReturnTimer = setTimeout(() => {
                    ...
                    if (isPhysicalESP) {
                        ...
                        // Skipped if closeTemple() already dispatched 'close'
                        // immediately (see aartiPhysicalAlreadyDispatched) -
                        // sending it again here would restart the Aarti chant
                        // the device already began playing several seconds ago.
                        if (!aartiPhysicalAlreadyDispatched) {
