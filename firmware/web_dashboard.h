...
(function () {
    ...
    <script>
        ...
        const AARTI_FALLBACK_DURATION_MS = 331520; // r132: GaneshAarti.mp3 (3:26) + Ganeshmantra8.mp3 (2:05) as one combined closing block, matches config.h's AARTI_DURATION
        ...
        // r131/r132: kept in sync with GanapatiAI.ino's own mantraTracks[] -
        // track 14's duration corrected to its real re-recorded length
        // (102000ms, was 175730), and track 10 removed entirely (it now
        // plays as part 2 of the closing Aarti block instead - see
        // AARTI_PART2_TRACK/AARTI_PART2_DURATION in config.h).
        const mantraTracks = [
