...
#define FIRMWARE_VERSION "2026-08-29-r135"
...
// r132: track 10 (Ganeshmantra8.mp3, formerly in mantraTracks[] - see its
// own removal comment there) now plays immediately after AARTI_TRACK as
// one continuous ritual, per direct request. AARTI_DURATION is the
...
#define AARTI_DURATION (AARTI_PART1_DURATION + AARTI_PART2_DURATION) // r130/r132: matches web dashboard's AARTI_FALLBACK_DURATION_MS
